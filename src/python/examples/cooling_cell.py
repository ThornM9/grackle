...
if __name__ == "__main__":
    ...
    # pyplot.plot(data["time"].to("Myr"), data["HI"], label="HI")
    # pyplot.plot(data["time"].to("Myr"), data["HII"], label="HII")
    # pyplot.plot(data["time"].to("Myr"), data["HeI"], label="HeI")
    # pyplot.plot(data["time"].to("Myr"), data["HeII"], label="HeII")
    # pyplot.plot(data["time"].to("Myr"), data["HeIII"], label="HeIII")
    pyplot.legend()
    # pyplot.plot(p1)
    # pyplot.legend(
    #     [p1, p2, p3, p4, p5],
